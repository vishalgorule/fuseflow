 ...
 * This is the wire contract on the {@code activity-dispatch} topic — produced by the engine's
 * dispatcher, consumed by the worker SDK. Serialized as JSON with the project's Jackson 3
 * {@code ObjectMapper} (engine and SDK share this record, so the contract cannot drift).
 *
